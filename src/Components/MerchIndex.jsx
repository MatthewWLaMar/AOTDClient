...
class MerchIndex extends Component {
    ...
    render() { 
        return ( <div className='merchIndexDiv'>
            <Col className='cardColumn'>
                <div className='cardRow'> 
                <MerchCreate fetchMerchPosts={this.fetchMerchPosts} token={this.props.token}/>
                </div>
                <CardGroup className='cardGroup'>
                <MerchCards merchandise={this.state.merchandise} fetchMerchPosts={this.fetchMerchPosts} editUpdateMerchPost={this.editUpdateMerchPost} updateOn={this.updateOn} token={this.token}/>
                </CardGroup>
                
                
                {this.state.updateActive ? <MerchEdit merchandiseToUpdate={this.merchandiseToUpdate}  updateOff={this.updateOff} token={this.props.token} fetchMerchPosts={this.fetchMerchPosts}/> : <></>} 
